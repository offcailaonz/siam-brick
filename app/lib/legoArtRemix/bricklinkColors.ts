...
export const KNOWN_BRICKLINK_STUD_COLOR_NAMES = [
    "Black",
    "Blue",
    "Bright Green",
    "Bright Light Yellow",
...
export const KNOWN_BRICKLINK_TILE_COLOR_NAMES = [
    "Black",
    "Blue",
    "Bright Light Blue",
    "Bright Light Orange",
...
export const BRICKLINK_STUD_COLORS = ALL_BRICKLINK_SOLID_COLORS.filter((color) =>
    KNOWN_BRICKLINK_STUD_COLOR_NAMES.includes(color.name)
).sort((a, b) => {
    return a.name > b.name ? 1 : -1;
});

export const BRICKLINK_TILE_COLORS = ALL_BRICKLINK_SOLID_COLORS.filter((color) =>
